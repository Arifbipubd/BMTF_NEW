  ...
  return (
    <Layout pageTitle='BMTF | BMTF Crafties Factory'>
      ...
      <section>
        ...
        />
        <ConnectBMTF
          imageSrc='/assets/images/allVerticals/crafties.jpg'
          contactFirst='Marketing Executive, BMTF Crafties Factory'
          contactSecond='Bangladesh Machine Tools Factory Ltd, Gazipur'
          phone='+880 1769-044251'
          email='bmtfcrafties@gmail.com'
        />
      </section>
    </Layout>
  );
