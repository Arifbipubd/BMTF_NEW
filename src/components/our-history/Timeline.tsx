      ...
      <div className='container mx-auto flex items-center justify-center'>
        <div className=''>
          {timeline.map((item, index, array) => (
            <div
              className='relative grid grid-cols-5 md:grid-cols-7 justify-center gap-6 lg:gap-[30px] 2xl:gap-[32px]'
              key={item.id}
            >
              <div className='hidden  py-3 md:block col-span-1 md:col-span-2'>
              ...
              <div className='relative mb-[30px] col-span-4'>
                ...
                <div className='relative z-10 flex flex-col lg:flex-row lg:items-center gap-4 lg:gap-[30px]'>
                  <div className='lg:w-1/2'>
                    ...
                    <img src={item.imageSrc} alt='' className='h-full w-full' />
                  </div>
                  <div className='lg:w-1/2'>
