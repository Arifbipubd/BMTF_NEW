...
export default function CflBannerSection({}: Props) {
    return (
        ...
        `}
            >
                <div className={`bg-[url('/assets/images/verticals/Rectangle.png')] bg-no-repeat bg-cover bg-center 
                    z-20 py-14 md:py-[67px] px-20 md:px-24 lg:px-[107px] border-l-[4px] border-l-secondary border-l-opacity-50` 
                }>
                    <p className="text-white text-[26px] md:text-3xl lg:text-[33px] font-extrabold italic">
