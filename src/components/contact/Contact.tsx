        ...
        <div className="bg-skyLight py-14 md:py-16 lg:py-[70px]">
            ...
            >
                <div className="flex flex-col justify-center gap-5 md:gap-6 lg:gap-[30px]">
                    <div>
                        <h2 className="text-primary font-3xl md:text-[34px] lg:text-[37px] 2xl:text-[2.5rem] font-bold leading-[55.5px]">
                            Get in touch with us
                        </h2>
                    </div>
                    <div>
                        <p className="text-[#5A5A65] text-sm  2xl:text-base leading-[21px] capitalize">
                    ...
                    <div>
                        ...
                        <div>
                            <p className="text-[#5A5A65] text-sm 2xl:text-base md:leading-[21px] capitalize mb-2.5 md:mb-4 lg:mb-5">
                                Factory Office: +880-2-996618078
                            </p>

                            <p className="text-[#5A5A65] text-sm 2xl:text-base md:leading-[21px] capitalize">
