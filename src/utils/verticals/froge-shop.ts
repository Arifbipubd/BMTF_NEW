export const forgeAim: Array<any> = [
  {
    ...
    text: [
      {
        id: 11,
        innerText: `The aim of the Forging Shop is to manufacture products with the highest quality 
        of forging, enabling us to expand our current market and explore new business opportunities, 
