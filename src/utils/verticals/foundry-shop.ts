export const foundryAim: Array<any> = [
    {
        id: 1,
        heading: "Our Aim",
        text: [{
...
export const listItems: Array<any> = [
    {
        id: 1,
        label: 'Non-Ferrous Metal Casting Process'
    },
    {
        id: 2,
        label: 'Ferrous Metal Casting Process'
    },
    {
        id: 3,
        label: 'Crucible Furnace Production Process for ferrous casting'
    },
    {
        id: 4,
        label: 'Cutting'
