...
export const singleNews: any = {
  ...
  7: {
    ...
    description: [
      ...
      `For dealership inquiries: 01769044261`,
      `For bulk purchases: 01769044262`,
      `These dedicated phone numbers have been established to streamline communication and provide prompt assistance to individuals and businesses interested in partnering with BMTF Limited or procuring products in large quantities.`,
      `As one of the leading state-owned commercial entities operating under the management of the Bangladesh Army, BMTF Limited is committed to fostering collaboration and meeting the diverse needs of its customers and partners. With this initiative, the company aims to further strengthen its engagement with dealers and bulk buyers, ensuring a seamless and efficient experience.`,
      `For inquiries regarding dealership opportunities or bulk purchases, interested parties are encouraged to reach out to BMTF Limited through the newly introduced phone numbers, facilitating direct communication and expediting the process of partnership and procurement.`,
      `BMTF Limited remains dedicated to delivering excellence in its operations and fostering mutually beneficial relationships with its stakeholders. The introduction of dedicated phone numbers for dealership and bulk purchases underscores the company's commitment to innovation and customer-centricity, reaffirming its position as a leading player in Bangladesh's industrial landscape.`,
    ],
  },
  8: {
    imageSrc: "/assets/images/news-and-tender/TradeFair.jpg",
    title:
      "BMTF Limited Makes Debut Appearance at Dhaka International Trade Fair 2024",
    description: [
      `Bangladesh Machine Tools Factory Limited (BMTF Limited), a prominent state-owned commercial entity under the supervision of the Bangladesh Army, has marked its inaugural presence at the prestigious Dhaka International Trade Fair 2024, organized by the Export Promotion Bureau. The event, drawing massive crowds on its weekly holiday, took place at the Bangabandhu Bangladesh-China Friendship Exhibition Centre in Purbachal, Dhaka.`,
      `BMTF Limited's stall, located in General Pavilion 14, showcased its diverse range of offerings and capabilities to the enthusiastic visitors thronging the fairgrounds. As one of the leading entities in Bangladesh's industrial landscape, BMTF Limited spans over 156.47 acres of land in Shimultoli, Gazipur, comprising 19 dynamic factories.`,
      `Led by the Chief of Army Staff as the Board Chairman and supported by a capable Managing Director, BMTF Limited has continuously diversified its enterprises to contribute significantly to the national economy. The company's participation in the Dhaka International Trade Fair underscores its ambition to attain recognition as a renowned conglomerate on a global scale.`,
      `With a dedicated workforce comprising both military and civilian personnel, BMTF Limited is committed to furthering Bangladesh's journey towards economic prosperity, aligning its efforts with the ambitious 'Delta Plan 2100'. The company's consistent revenue generation plays a pivotal role in fostering substantial employment opportunities and catalyzing industrial growth, thereby shaping the nation's progress.`,
      `The 28th edition of the Dhaka International Trade Fair-2024, which commenced on January 21 and will conclude on February 20, has provided BMTF Limited with a platform to showcase its contributions to Bangladesh's industrial landscape and engage with stakeholders and visitors seeking innovative solutions and partnerships.`,
      `As BMTF Limited continues to expand its footprint and diversify its offerings, its participation in the Dhaka International Trade Fair 2024 exemplifies its commitment to driving economic growth and fostering collaboration in Bangladesh's thriving business ecosystem.`,
    ],
  },
  9: {
    imageSrc: "/assets/images/news-and-tender/SecondPrize.jpg",
    title:
      "BMTF Limited Secures Second Prize at Dhaka International Trade Fair 2024",
    description: [
      `Bangladesh Machine Tools Factory Limited (BMTF Limited) has achieved yet another milestone by clinching the prestigious Silver Crest, the second prize in the General Pavilion category, at the Dhaka International Trade Fair 2024. The event, organized by the Export Promotion Bureau, witnessed a vibrant showcase of innovation and enterprise at the Bangabandhu Bangladesh-China Friendship Exhibition Centre in Purbachal, Dhaka.`,
      `BMTF Limited's exemplary display at the trade fair, held from January 21 to February 20, garnered widespread acclaim and recognition from visitors and industry experts alike. With its stall located in General Pavilion 14, BMTF Limited showcased its diverse range of offerings and highlighted its commitment to driving economic growth and innovation in Bangladesh.`,
      `The Silver Crest award was presented by Ahasanul Islam Titu, MP, Honorable State Minister of the Ministry of Commerce, in recognition of BMTF Limited's outstanding contributions to the industrial landscape of Bangladesh.`,
      `As one of the leading state-owned commercial entities under the management of the Bangladesh Army, BMTF Limited operates across 156.47 acres of land in Shimultoli, Gazipur, encompassing 19 dynamic factories. Led by the Chief of Army Staff as the Board Chairman and supported by a capable Managing Director, the company has continually diversified its enterprises to bolster the national economy and establish itself as a renowned conglomerate on a global scale.`,
      `The recognition received by BMTF Limited at the Dhaka International Trade Fair 2024 underscores the company's commitment to excellence and innovation in its operations. With a dedicated workforce comprising military and civilian personnel, BMTF Limited remains steadfast in its mission to contribute to Bangladesh's journey towards economic prosperity, in alignment with the ambitious 'Delta Plan 2100'.`,
      `The Silver Crest award serves as a testament to BMTF Limited's outstanding contributions to Bangladesh's industrial landscape and its relentless pursuit of excellence in all endeavors. As the company continues to expand its footprint and diversify its offerings, it remains poised to play a pivotal role in driving economic growth and fostering collaboration within Bangladesh's vibrant business ecosystem.`,
    ],
  },
  10: {
    imageSrc: "/assets/images/news-and-tender/BMTF-SPRAC.jpg",
    title:
      " Bangladesh Machine Tools Factory (BMTF) Unveils Innovative SPARC Housing Solution",
    description: [
      `In a bid to innovate and contribute to the welfare of its citizens, Bangladesh Machine Tools Factory (BMTF), under the supervision of the Bangladesh Army, has introduced a groundbreaking housing solution named SPARC.`,
      `SPARC, the latest innovation from BMTF, is designed to be easily deployable and usable as a cottage, offering a swift response to housing needs in disaster-stricken areas. With a deployment time of just 2 to 3 days, SPARC provides a safe and affordable housing option for those in need, particularly for individuals lacking the resources to construct traditional homes.`,
      `"We aim to provide affordable housing solutions to those who may not have the means to build conventional houses," stated a spokesperson from BMTF.`,
      `Moreover, SPARC doubles as a reliable shelter during national disasters, offering protection and security to its occupants. Its customizable size further enhances its adaptability to diverse needs, ensuring its suitability for various scenarios.`,
      `In addition to SPARC, BMTF is expanding its manufacturing capabilities to cater to the needs of the Bangladesh Army. Plans are underway to innovate military vehicles and potentially develop tankers and other military equipment domestically, marking a significant stride towards self-sufficiency in defense technology.`,
      `Furthermore, BMTF is not limiting its scope to military endeavors alone. The factory boasts a diverse range of operations, including a forge foundry where agricultural carts are being produced for farmers. By manufacturing such equipment domestically, BMTF aims to reduce dependency on imports and offer affordable solutions to local farmers, thereby contributing to the growth of the agricultural sector.`,
      `BMTF, as a commercial enterprise led by the Bangladesh Army, not only aims to bolster the country's economy but also strives to create employment opportunities for Bangladeshis. Through its multifaceted operations, BMTF is poised to strengthen the capabilities of the Bangladesh Army while serving the broader interests of the nation.`,
    ],
  },
  11: {
    imageSrc: "/assets/images/news-and-tender/BMTF-Vertipark.jpg",
    title: "BMTF Limited Launches VertiPark: Innovating Parking Solutions",
    description: [
      `Bangladesh Machine Tools Factory Limited (BMTF Limited) has introduced VertiPark, a groundbreaking Vertical Parking System aimed at revolutionizing parking solutions for residential and commercial spaces.`,
      `VertiPark offers a unique approach to parking, optimizing space utilization while maintaining efficiency and convenience. With customizable units available in various sizes and colors, customers can tailor their VertiPark to suit their specific needs and preferences.`,
      `The launch of VertiPark underscores BMTF Limited's commitment to innovation and addressing contemporary challenges in urban environments. By providing a space-saving solution, the company aims to alleviate parking congestion and enhance the overall parking experience for users.`,
      `In addition to its innovative design, VertiPark comes with reliable before and after-sales service, ensuring seamless installation and ongoing maintenance for customers.`,
      `BMTF Limited's foray into parking solutions with VertiPark marks a significant step forward in the company's diversification efforts, expanding its portfolio beyond its traditional manufacturing operations.`,
      `With VertiPark, BMTF Limited aims to set a new standard in parking solutions, offering a sophisticated and efficient alternative for residential complexes, commercial properties, and public facilities.`,
    ],
  },
};
